    ...
    <div className="bg-slate-900 min-h-screen text-white">
      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            <p>Your privacy is important to us. It is NexusStream's policy to respect your privacy regarding any information we may collect from you across our website, and other sites we own and operate.</p>
          ...
          >
            ...
            <h3>Use License</h3>
            <p>Permission is granted to temporarily download one copy of the materials on NexusStream's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title.</p>
            <h3>Disclaimer</h3>
            <p>The materials on NexusStream's website are provided on an 'as is' basis. NexusStream makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.</p>
          </PolicySection>
